...
$shuffledProducts = getShuffledProductsByCatId($product['cat_id'], 4);
$category = getOneCategory($product['cat_id']);
            ...
            <div class="row details_row">
                ...
                <div class="col-lg-6">
                    <div class="details_image">
                        <div class="details_image_large"><img src="images/products/<?php echo $product['img']; ?>" alt="<?php echo $product['name']; ?>"><!--<div class="product_extra product_new"><a href="categories.html">New</a></div>--></div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="product_grid">
                        ...
                        <!-- Product -->
                 <?php foreach ($shuffledProducts as $shuffledProduct) {
                     if ($shuffledProduct['id'] === $id) {
                         continue;
                     }?>

                        <div class="product">
                            <div class="product_image"><img src="images/products/<?php echo $shuffledProduct['img']; ?>" alt="<?php echo $shuffledProduct['name']; ?>"></div>
                           <!-- <div class="product_extra product_new"><a href="product.php?<?php /*echo urlencode($shuffledProduct['id']); */?>">New</a></div>-->
                            <div class="product_content">
                                <div class="product_title"><a href="product.php?id=<?php echo $shuffledProduct['id']; ?>&amp;name=<?php echo urlencode($shuffledProduct['name']); ?>"><?php echo $shuffledProduct['name']; ?></a></div>
                                <div class="product_price">$<?php echo $shuffledProduct['price']; ?></div>
                            </div>
                        </div>
                <?php } ?>
                    </div>
